...
/// Renders the embed content of a post — images (up to 10 in a grid), videos (with play overlay),
...
struct PostEmbedView: View {
    ...
    /// Up to 10 images in a flexible grid. Single images render full-width; 2+ render in 2-column layout.
    private func imageGrid(images: [RichEmbedImage]) -> some View {
        ...
        return LazyVGrid(
            ...
            ForEach(Array(images.prefix(10).enumerated()), id: \.offset) { index, item in
