...
struct LikesListView: View {
    ...
    private func loadLikes() async {
        ...
        errorMessage = nil
        do {
            let response = try await container.social.fetchLikes(uri: uri, cursor: nil, account: account, appPassword: appPassword)
    ...
    private func loadMore() async {
        ...
        do {
            let response = try await container.social.fetchLikes(uri: uri, cursor: cursor, account: account, appPassword: appPassword)
            likes += response.likes
