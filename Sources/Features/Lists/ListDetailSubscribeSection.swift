...
/// Section for subscribing/unsubscribing to a moderation or curation list,
/// with error display and a prominent toggle button.
/// Works for all non-owned list kinds (moderation, internal, regular).
