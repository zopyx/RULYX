...
## Purpose
Enforces the documented toolbar/dismiss rules (AGENTS.md) across all sheets and overlays so dismissal affordances look and behave identically app-wide. Closes finding 9 of the 360° UX review (`UX.md`).
