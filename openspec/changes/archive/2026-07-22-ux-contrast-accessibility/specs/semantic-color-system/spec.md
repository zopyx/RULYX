...
## Purpose
Consolidates hardcoded system colors onto the semantic palette (`Color+RULYX.swift`) and establishes a brand AccentColor so the app tint matches the brand in both color schemes. Closes findings 6 and 7 of the 360° UX review (`UX.md`).
