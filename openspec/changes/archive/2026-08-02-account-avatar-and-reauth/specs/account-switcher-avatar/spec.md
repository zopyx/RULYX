...
## Purpose
The account switcher entry point (bottom-right tab bar icon) always displays the active account's avatar so the user can see at a glance which account is active.
