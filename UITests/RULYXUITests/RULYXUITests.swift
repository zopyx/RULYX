...
final class RULYXUITests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        XCTAssertTrue(
            tabButton.waitForExistence(timeout: 8),
    ...
    func testOnboardingFlow() {
        ...
        XCTAssertTrue(
            getStartedButton.waitForExistence(timeout: 8),
        ...
        for tabID in expectedTabIDs {
            XCTAssertTrue(
                onboardingApp.buttons[tabID].exists,
    ...
    func testSettingsNavigationAndToggle() {
        ...
        guard autoBlockSwitch.waitForExistence(timeout: 3) else {
            ...
            XCTAssertTrue(
                autoBlockSwitch.waitForExistence(timeout: 3),
    ...
    func testAccountsTabShowsAccounts() {
        ...
        XCTAssertTrue(
            teamAlpha.waitForExistence(timeout: 5),
    ...
    func testModerationTabNavigation() {
        ...
        XCTAssertTrue(
            app.buttons["tab-moderation"].exists,
    ...
    func testInfoTabContent() {
        ...
        XCTAssertTrue(
            overviewSegment.waitForExistence(timeout: 5),
    ...
    func testTabPersistenceAcrossAllTabs() {
        let tabIDs = [
            "tab-moderation", "tab-timeline", "tab-notifications",
            "tab-chat", "tab-info", "tab-settings", "tab-accounts",
        ]
        ...
        for tabID in tabIDs {
            ...
            let moderationTab = app.buttons["tab-moderation"]
            XCTAssertTrue(
                moderationTab.waitForExistence(timeout: 3),
        ...
        sleep(1)
        XCTAssertTrue(
            app.buttons["tab-moderation"].waitForExistence(timeout: 3),
